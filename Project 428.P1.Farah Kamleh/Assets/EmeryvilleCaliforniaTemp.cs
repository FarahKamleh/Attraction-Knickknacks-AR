...
public class EmeryvilleCaliforniaTemp : MonoBehaviour
{
    ...
    // EDIT: provide the weather for Emeryville, California in Metric (degrees C)
    string url = "https://api.openweathermap.org/data/2.5/weather?lat=37.8395&lon=-122.2892&APPID=fb59b33280dd6620c8bad2aafba0cc1d&units=metric";
