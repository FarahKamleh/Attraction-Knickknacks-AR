...
public class WeatherAPIScript : MonoBehaviour
{
    ...
    // EDIT: provide the weather for Reedsport, Oregon in Imperial (degrees F)
    string url = "https://api.openweathermap.org/data/2.5/weather?lat=43.7023&lon=-124.0968&APPID=fb59b33280dd6620c8bad2aafba0cc1d&units=imperial";
